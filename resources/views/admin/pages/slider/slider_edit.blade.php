                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="col-lg-12 ">
                        <div class="input-file input-file-image">
                            <img class="img-upload-preview mb-2 " style="height:200px"   src="{{ asset('assets/admin/images/slider/'.$slider->image) }}" alt="preview">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="subtitle" class="form-control form-control-lg" id="basicInput" value="{{ $slider->subtitle }}" required>
                            </div>
                        </div>
                    </div>
